...
public class ActiTimeValidLogin extends BaseTest {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		usnTB.sendKeys(flib.readDataFromProperty("./src/test/resources/config.properties","Username"));
		usnTB.sendKeys(flib.readDataFromProperty(PROP_PATH,"Username"));
		//identify password Text Box
		WebElement passTB = driver.findElement(By.name("pwd"));
		passTB.sendKeys(flib.readDataFromProperty("./src/test/resources/config.properties","Password"));
